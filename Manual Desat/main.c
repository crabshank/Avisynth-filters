...
WPchgRGB_bk_gc[0]=MAX(WPchgRGB_bk_gc[0],curr_rgb_dst_fnl[0]);
WPchgRGB_bk_gc[1]=MAX(WPchgRGB_bk_gc[1],curr_rgb_dst_fnl[1]);
WPchgRGB_bk_gc[2]=MAX(WPchgRGB_bk_gc[2],curr_rgb_dst_fnl[2]);
}
